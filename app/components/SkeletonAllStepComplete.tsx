...
const SkeletonAllStepComplete = () => {
  return (
    ...
    <div>
      ...
      <p>
        <span>Client ID: </span>
        <Skeleton width={120} height={20} style={{ display: "inline-block" }} />
      </p>
      <p>
      ...
      <p className="text-gray-600 mt-1 text-sm">
        <Skeleton width={160} height={16} style={{ display: "inline-block" }} />
      </p>
    </div>
    ...
    <div>
      ...
      <p>
        ...
        <Skeleton width={140} height={20} style={{ display: "inline-block" }} />
      </p>
    </div>
    ...
    <div>
      ...
      <p>
        ...
        <Skeleton width={90} height={20} style={{ display: "inline-block" }} />
      </p>
    </div>
    ...
    <div>
      ...
      <Skeleton width={200} height={36} style={{ marginTop: 8 }} />
      <Skeleton width={250} height={36} style={{ marginTop: 8 }} />
    </div>
  </div>
  )
}
